...
import se.vgregion.webbtidbok.mock.sectraws.jaxb.BookingInfo;
import se.vgregion.webbtidbok.mock.sectraws.jaxb.ObjectFactory;
import se.vgregion.webbtidbok.mock.sectraws.jaxb.Section;
import se.vgregion.webbtidbok.mock.sectraws.jaxb.TimeBlock;
...
public class BusinessObjectHolder {
     ...
     * @param examNo The examination number.
    ...
    public List<XMLGregorianCalendar> listFreeDays(XMLGregorianCalendar startDate, XMLGregorianCalendar endDate,
            String examNo, String sectionId) throws InvalidExamNoException, InvalidSectionIdException {
    ...
    public List<TimeBlock> listFreeTimes(XMLGregorianCalendar startDate, XMLGregorianCalendar endDate,
            String examNo, String sectionId) throws InvalidExamNoException, InvalidSectionIdException {
        ...
        List<TimeBlock> freeBlocks = filterBlocksBySection(sectionId,
                filterBlocksInSpan(startDate, endDate, getFreeTimes()));
    ...
    public BookingInfo reschedule(String examNo, String newTimeId, XMLGregorianCalendar startTime)
        throws InvalidExamNoException, InvalidTimeIdException, TimeAlreadyBookedException, UnknownFailureException {
        if (!bookings.containsKey(examNo)) {
            throw new InvalidExamNoException();
        }
